...
| Technical reviewer | `harutasti` | G7 self-review completed |
| Test reviewer | `harutasti` | G7 self-review completed |
| Security reviewer | `harutasti` | G7 self-review completed with open release blockers |
...
| G5 | [Detailed design](detailed-design.md) | Approved | [PR #23](https://github.com/harutasti/cppseed/pull/23), [CI run 29473956870](https://github.com/harutasti/cppseed/actions/runs/29473956870) | Approved 2026-07-16 |
| G6 | [Threat model](threat-model.md) | Approved | [PR #24](https://github.com/harutasti/cppseed/pull/24), [CI run 29476132679](https://github.com/harutasti/cppseed/actions/runs/29476132679), [safe-validation 29476132826](https://github.com/harutasti/cppseed/actions/runs/29476132826) | Approved 2026-07-16; release blockers remain open |
| G7 | [Test plan](test-plan.md)、[Traceability](traceability.md) | Approved | [PR #25](https://github.com/harutasti/cppseed/pull/25), [CI run 29477256964](https://github.com/harutasti/cppseed/actions/runs/29477256964), [safe-validation 29477256937](https://github.com/harutasti/cppseed/actions/runs/29477256937) | Approved 2026-07-16; 46 cases planned, release blockers remain open |
...
| `RISK-SC-001` | Risk | trusted rootが更新・revocation情報に追随しない可能性 | Security reviewer | G11 | Conditional acceptance; verify G10/G11 |
| `RISK-SC-002` | Risk | SBOM scannerがsystem dependencyを完全に検出できない | Technical reviewer | G7 | Accepted limitation; verify G7/G9 |
| `RISK-SC-003` | Risk | SPDX post-processingのsemantic誤り | Technical reviewer | G9 | Release blocker; verify G7/G9 |
| `RISK-SC-004` | Risk | dependency lockのenvironment marker漏れ | Technical reviewer | G9 | Release blocker; verify G7/G9 |
| `RISK-SC-005` | Risk | tag rulesetとmain required status checksが未設定 | Security reviewer | G10 | Release blocker; resolve before trusted release |
| `RISK-SC-006` | Risk | offline bundle/rootのsame-channel bootstrap | Security reviewer | G11 | Conditional acceptance; verify G7/G10 |
| `RISK-SC-007` | Risk | maintainer account compromiseとsolo self-review | Security reviewer | G11 | Mitigate in G10; acceptance deferred |
| `RISK-SC-008` | Risk | GitHub/Sigstore/TUF/runner platform compromise/outage | Security reviewer | G11 | Inherited risk; fail closed and review |
| `RISK-SC-009` | Risk | provenanceはcodeの安全性自体を証明しない | Security reviewer | G6 | Accepted scope boundary; disclose G10 |
| `RISK-SC-010` | Risk | consumerがverificationをskipまたは弱いpolicyを使う | Test reviewer | G11 | Mitigate in G7/G10; acceptance deferred |
...
| G5 | Technical | `harutasti` | Approved | 2026-07-16 | [PR #23](https://github.com/harutasti/cppseed/pull/23) |
| G5 | Testability | `harutasti` | Approved | 2026-07-16 | [PR #23](https://github.com/harutasti/cppseed/pull/23) |
| G5 | Security | `harutasti` | Approved | 2026-07-16 | [PR #23](https://github.com/harutasti/cppseed/pull/23) |
| G6 | Technical | `harutasti` | Approved | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/24#pullrequestreview-4710964641) |
| G6 | Testability | `harutasti` | Approved | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/24#pullrequestreview-4710965122) |
| G6 | Security | `harutasti` | Approved with open release blockers | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/24#pullrequestreview-4710965575) |
| G7 | Technical | `harutasti` | Approved | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/25#pullrequestreview-4711117657) |
| G7 | Testability | `harutasti` | Approved | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/25#pullrequestreview-4711118538) |
| G7 | Security | `harutasti` | Approved with open release blockers | 2026-07-16 | [PR review](https://github.com/harutasti/cppseed/pull/25#pullrequestreview-4711118833) |
...
| 2026-07-16 | G5内部設計のreviewを開始 | [PR #23](https://github.com/harutasti/cppseed/pull/23) | `harutasti` |
| 2026-07-16 | G5内部設計を観点別self-reviewしbaselineとして承認 | [PR #23](https://github.com/harutasti/cppseed/pull/23) | `harutasti` |
| 2026-07-16 | G6脅威分析のreviewを開始 | [PR #24](https://github.com/harutasti/cppseed/pull/24) | `harutasti` |
| 2026-07-16 | G6脅威分析を観点別self-reviewし、未解決release blockerを維持してbaselineを承認 | [PR #24](https://github.com/harutasti/cppseed/pull/24) | `harutasti` |
| 2026-07-16 | G7テスト計画とトレーサビリティのreviewを開始 | [PR #25](https://github.com/harutasti/cppseed/pull/25) | `harutasti` |
| 2026-07-16 | G7を観点別self-reviewし、46件をPlannedとしてtest/traceability baselineを承認 | [PR #25](https://github.com/harutasti/cppseed/pull/25) | `harutasti` |
