...
| Technical reviewer | `harutasti` | G6 review in progress |
| Test reviewer | `harutasti` | G6 review in progress |
| Security reviewer | `harutasti` | G6 review in progress |
...
| G6 | [Threat model](threat-model.md) | In review | [PR #24](https://github.com/harutasti/cppseed/pull/24) | Pending |
