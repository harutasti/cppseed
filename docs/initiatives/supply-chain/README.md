...
| Technical reviewer | `harutasti` | Pending separate review |
| Test reviewer | `harutasti` | Pending |
| Security reviewer | `harutasti` | Pending |
...
|---:|---|---|---|---|
| G0 | Initiative | In review | [PR #18](https://github.com/harutasti/cppseed/pull/18) | Pending |
| G1 | [Requirements](requirements.md) | In review | [PR #18](https://github.com/harutasti/cppseed/pull/18) | Pending |
| G2 | Feasibility report | Not started | — | — |
...
|---:|---|---|---|---|---|
| G0-G1 | Technical | `harutasti` | Pending | — | [PR #18](https://github.com/harutasti/cppseed/pull/18) |
| G0-G1 | Security | `harutasti` | Pending | — | [PR #18](https://github.com/harutasti/cppseed/pull/18) |
