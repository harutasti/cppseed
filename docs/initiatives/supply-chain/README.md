...
| Technical reviewer | `harutasti` | G7 review in progress |
| Test reviewer | `harutasti` | G7 review in progress |
| Security reviewer | `harutasti` | G7 review in progress; release blockers remain open |
...
| G7 | [Test plan](test-plan.md)、[Traceability](traceability.md) | In review | [PR #25](https://github.com/harutasti/cppseed/pull/25) | Pending |
