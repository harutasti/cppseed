...
| Technical reviewer | `harutasti` | G2 self-review completed |
| Test reviewer | `harutasti` | G2 self-review completed |
| Security reviewer | `harutasti` | G2 self-review completed |
...
| G2 | [Feasibility report](feasibility-report.md) | Approved | [PR #19](https://github.com/harutasti/cppseed/pull/19), [Run 29467892590](https://github.com/harutasti/cppseed/actions/runs/29467892590) | Approved 2026-07-16 |
| G3 | External design | Not started | — | — |
| G4 | ADRs | Not started | — | — |
...
|---|---|---|---|---|---|
| `DEC-SC-001` | Decision | SPDX versionと生成・validation tool | Technical reviewer | G3 | Open |
| `DEC-SC-002` | Decision | provenanceへ補助build metadataを結び付ける方法 | Security reviewer | G3 | Open |
| `DEC-SC-003` | Decision | offline bundleとtrusted rootの命名・配布・更新 | Security reviewer | G3 | Open |
| `RISK-SC-001` | Risk | trusted rootが更新・revocation情報に追随しない可能性 | Security reviewer | G6 | Open |
| `RISK-SC-002` | Risk | SBOM scannerがsystem dependencyを完全に検出できない | Technical reviewer | G3 | Open |
| `RISK-SC-003` | Risk | SPDX post-processingのsemantic誤り | Technical reviewer | G7 | Open |
| `RISK-SC-004` | Risk | dependency lockのenvironment marker漏れ | Technical reviewer | G3 | Mitigated for spike |
...
| G2 | Technical | `harutasti` | Approved | 2026-07-16 | Result PR under review |
| G2 | Testability | `harutasti` | Approved | 2026-07-16 | Result PR under review |
| G2 | Security | `harutasti` | Approved | 2026-07-16 | Result PR under review |
...
| 2026-07-16 | G2全項目をPassし、結果報告と一時write経路cleanupを作成 | Result PR under review | `harutasti` |
