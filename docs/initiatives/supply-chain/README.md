...
| Technical reviewer | `harutasti` | G4 review pending |
| Test reviewer | `harutasti` | G4 review pending |
| Security reviewer | `harutasti` | G4 review pending |
...
| G4 | [ADR-0001](adr/0001-spdx-2-3-toolchain.md)、[ADR-0002](adr/0002-signed-build-metadata-predicate.md)、[ADR-0003](adr/0003-offline-bundle-and-trusted-root.md) | In review | Pending | Pending |
...
|---|---|---|---|---|---|
| `DEC-SC-001` | Decision | SPDX versionと生成・validation tool | Technical reviewer | G4 | [ADR-0001](adr/0001-spdx-2-3-toolchain.md) Proposed |
| `DEC-SC-002` | Decision | provenanceへ補助build metadataを結び付ける方法 | Security reviewer | G4 | [ADR-0002](adr/0002-signed-build-metadata-predicate.md) Proposed |
| `DEC-SC-003` | Decision | offline bundleとtrusted rootの命名・配布・更新 | Security reviewer | G4 | [ADR-0003](adr/0003-offline-bundle-and-trusted-root.md) Proposed |
...
| 2026-07-16 | G4で3件のArchitecture Decision Recordのreviewを開始 | Pending | `harutasti` |
